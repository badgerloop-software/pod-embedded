...
int rms_parser(uint32_t id, uint8_t *rmsData){
	switch(id){
		...
		case (0xa5):
			...
			printf("Motor Speed: %d\r\n", data->rms->motor_speed);
			printf("Elect. Freq: %d\r\n", data->rms->electrical_freq);
			break;
		case (0xa6):
			...
			printf("Phase A Current: %d\r\n", data->rms->phase_a_current);
			printf("Phase B Current: %d\r\n", data->rms->phase_b_current);
			break;
		case (0xa7):
